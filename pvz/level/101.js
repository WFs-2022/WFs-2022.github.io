    ...
    LoadAccess: function(a) {
        ...
        NewEle("DivTeach", "div", 0, 0, EDAll); (function(d) {
            ...
            case 0:
                ...
                []);
                c.innerHTML = '<span style="font-size:22px">伙计，你听说过刺客吗？(点击继续)</span>';
                break;
            case 1:
                PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
                c.onclick = null;
                ...
                []);
                c.innerHTML = '<span style="font-size:22px">那些来去不明的杀手我最讨厌了！(点击继续)</span>';
                break;
            case 2:
                PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
                c.onclick = null;
...
{
    AZ: [[oCZombie, 1, 1],  [oCZombie2, 1, 5],  [oCZombie3, 2, 20],  [oCConeheadZombie, 2, 5],  [oCBucketheadZombie, 2, 10],  [othugZombie, 1, 3],  [oEunZombie, 1, 4]], 
    FlagNum: 30, 
    FlagToSumNum: {
