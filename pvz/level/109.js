    ...
    LoadAccess: function(a) {
        ...
        NewEle("DivTeach", "div", 0, 0, EDAll); (function(d) {
            ...
            case 0:
                ...
                []);
                c.innerHTML = '<span style="font-size:22px">我小时候很享受滑冰，那种在冰上的快速移动的感觉</span>';
                break;
            case 1:
                PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
                c.onclick = null;
                ...
                []);
                c.innerHTML = '<span style="font-size:22px">不过这里没有冰，只有油！(点击继续)</span>';
                break;
            case 2:
                PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
                c.onclick = null;
                ...
                []);
                c.innerHTML = '<span style="font-size:22px">而且不是我滑，是僵尸来滑！(点击继续)</span>';
                break;
            case 3:
                PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
                c.onclick = null;
                ...
                []);
                c.innerHTML = '<span style="font-size:22px">多放点陷阱来阻挡它们吧，比如大嘴花和土豆雷</span>';
                break;
            case 4:
                PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
                c.onclick = null;
                ...
                []);
                c.innerHTML = '<span style="font-size:22px">还有一个小秘密，木头都经不起火烧的！(点击继续)</span>';
                break;
            case 5:
...
{
    AZ: [[oCZombie, 1, 10, [10, 20, 30]], [oCZombie2, 1, 10, [10, 20, 30]], [oCZombie3, 1, 10, [10, 20, 30]], [oCZomboni, 2, 1]], 
    FlagNum: 30,
    FlagToSumNum: {
